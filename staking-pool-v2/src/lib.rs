...
pub struct StakingContract {
    ...
    pub paused: bool,
    pub whitelist_account_ids: LookupSet<AccountId>,
}
...
impl StakingContract {
    ...
    pub fn new(
        ...
        let mut this = Self {
            ...
            paused: false,
            whitelist_account_ids: LookupSet::new(b"w".to_vec()),
        };
    ...
    pub fn deposit(&mut self) {
        ...
        assert!(
            self.is_whitelisted_account_id(account_id),
    ...
    pub fn is_whitelisted_account_id(&self, account_id: AccountId) -> bool {
        self.whitelist_account_ids.contains(&account_id)
    }
    ...
    pub fn add_to_whitelist(&mut self, account_id: AccountId) {
        ...
        self.whitelist_account_ids.insert(&account_id);
    }

    pub fn remove_from_whitelist(&mut self, account_id: AccountId) {
        self.assert_owner();
        self.whitelist_account_ids.remove(&account_id);
    }
}
...
mod tests {
    ...
    fn test_restake_fail() {
        ...
        let receipts = get_created_receipts(); //env::created_receipts();
